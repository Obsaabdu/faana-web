  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {/* CTA */}
        <section className="py-20 bg-primary/20 dark:bg-card dark:text-primary text-primary-foreground relative overflow-hidden">
          <BackgroundShapes variant="justice" />
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            >
              ...
              <Button asChild size="lg" variant="secondary" className="group">
                <Link
                  href="/contact"
                  className="flex items-center gap-2 dark:bg-primary dark:text-primary-foreground"
                >
                  {t("getInTouch")}
