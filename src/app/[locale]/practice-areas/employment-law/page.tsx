...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Employment Law Services | Workplace Attorneys | FAANA Advocacy",
    description:
      "Expert employment law services for employers and employees. Employment contracts, workplace disputes, discrimination claims, and labor compliance.",
    keywords: [
      "employment lawyer",
      "labor attorney",
    ...
    openGraph: {
      title: "Employment Law Services | FAANA Advocacy",
      description:
        "Comprehensive employment law services for navigating workplace matters and labor regulations.",
      type: "website",
    },
  };
}
...
export default function EmploymentLawPage() {
  const t = useTranslations("EmploymentLawPage");

  // Structured Data for LegalService Schema
  const legalServiceSchema = {
    "@context": "https://schema.org",
    "@type": "LegalService",
    name: "Employment Law Services - FAANA Advocacy",
    description:
      "Comprehensive employment law services including contracts, workplace policies, and dispute resolution",
    provider: {
      "@type": "LegalService",
      name: "FAANA Advocacy",
      url: "https://faana.com",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Drafting employment agreements and severance packages",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Development of employee handbooks and compliance programs",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Representation in discrimination and harassment claims",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Ensuring compliance with wage and hour laws",
          },
        },
      ],
    },
                ...
                {[
                  {
                    ...
                    link: "/insights/employment-contracts-best-practices",
                  },
                  {
                    id: "insight2",
                    title: t("insight2Title"),
                    excerpt: t("insight2Excerpt"),
                    link: "/insights/workplace-harassment-prevention",
                  },
                  {
                    id: "insight3",
                    title: t("insight3Title"),
                    excerpt: t("insight3Excerpt"),
                    link: "/insights/labor-compliance-updates",
                  },
                ].map((insight) => (
                  <Card
                    key={insight.id}
