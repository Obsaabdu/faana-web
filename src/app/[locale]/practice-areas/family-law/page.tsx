...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Family Law Services | Divorce & Custody Attorneys | FAANA Advocacy",
    description:
      "Compassionate family law representation for divorce, child custody, spousal support, and adoption. Expert guidance through sensitive family matters.",
    keywords: [
      "family lawyer",
      "divorce attorney",
    ...
    openGraph: {
      title: "Family Law Services | FAANA Advocacy",
      description:
        "Compassionate and effective representation in family law matters with focus on protecting families and children.",
      type: "website",
    },
  };
}
...
export default function FamilyLawPage() {
  const t = useTranslations("FamilyLawPage");

  // Structured Data for LegalService Schema
  const legalServiceSchema = {
    "@context": "https://schema.org",
    "@type": "LegalService",
    name: "Family Law Services - FAANA Advocacy",
    description:
      "Compassionate family law services including divorce, custody, and support matters",
    provider: {
      "@type": "LegalService",
      name: "FAANA Advocacy",
      url: "https://faana.com",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Representation in divorce proceedings and legal separation",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Custody arrangements, visitation rights, and child support",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Alimony and spousal maintenance negotiations",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Drafting prenuptial and postnuptial agreements",
          },
        },
      ],
    },
                ...
                {[
                  {
                    ...
                    link: "/insights/divorce-process-guide",
                  },
                  {
                    id: "insight2",
                    title: t("insight2Title"),
                    excerpt: t("insight2Excerpt"),
                    link: "/insights/child-custody-considerations",
                  },
                  {
                    id: "insight3",
                    title: t("insight3Title"),
                    excerpt: t("insight3Excerpt"),
                    link: "/insights/prenuptial-agreements-explained",
                  },
                ].map((insight) => (
                  <Card
                    key={insight.id}
