...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Real Estate Law Services | Property Attorneys | FAANA Advocacy",
    description:
      "Comprehensive real estate legal services for property transactions, development, leasing, and disputes. Expert guidance for buyers, sellers, and investors.",
    keywords: [
      "real estate lawyer",
      "property attorney",
    ...
    openGraph: {
      title: "Real Estate Law Services | FAANA Advocacy",
      description:
        "Full-service real estate legal support for all types of property transactions and development projects.",
      type: "website",
    },
  };
}
...
export default function RealEstatePage() {
  ...
  const legalServiceSchema = {
    ...
    "@type": "LegalService",
    name: "Real Estate Law Services - FAANA Advocacy",
    description:
      "Comprehensive real estate legal services including transactions, development, and property disputes",
    provider: {
      "@type": "LegalService",
      name: "FAANA Advocacy",
      url: "https://faana.com",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description: "Purchase, sale, and financing of properties",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description: "Commercial and residential lease negotiations",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Representation in boundary disputes and property litigation",
          },
        },
      ],
    },
