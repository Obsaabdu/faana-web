...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title:
      "Intellectual Property Law | Patent & Trademark Attorneys | FAANA Advocacy",
    description:
      "Comprehensive IP protection services including patents, trademarks, copyrights, and trade secrets. Expert IP litigation and licensing attorneys.",
    keywords: [
    ...
    openGraph: {
      title: "Intellectual Property Law Services | FAANA Advocacy",
      description:
        "Protecting your innovations and brands in the global marketplace with expert IP legal services.",
      type: "website",
    },
  };
}
...
export default function IntellectualPropertyPage() {
  const t = useTranslations("IntellectualPropertyPage");

  // Structured Data for LegalService Schema
  const legalServiceSchema = {
    "@context": "https://schema.org",
    "@type": "LegalService",
    name: "Intellectual Property Services - FAANA Advocacy",
    description:
      "Comprehensive intellectual property protection including patents, trademarks, copyrights, and licensing",
    provider: {
      "@type": "LegalService",
      name: "FAANA Advocacy",
      url: "https://faana.com",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Patent prosecution, portfolio management, and analysis",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Trademark registration and brand protection strategies",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description: "Copyright registration, licensing, and enforcement",
          },
        },
        {
          "@type": "Offer",
                ...
                {[
                  {
                    ...
                    link: "/insights/patent-filing-strategies",
                  },
                  {
                    id: "insight2",
                    title: t("insight2Title"),
                    excerpt: t("insight2Excerpt"),
                    link: "/insights/trademark-protection-guide",
                  },
                  {
                    id: "insight3",
                    title: t("insight3Title"),
                    excerpt: t("insight3Excerpt"),
                    link: "/insights/ip-litigation-trends",
                  },
                ].map((insight) => (
                  <Card
                    key={insight.id}
